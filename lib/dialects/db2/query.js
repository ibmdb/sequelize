            ...
            if (err && err.message) {
              if(err.message.search("SQL0204N") != -1 &&
                ...
                err = null; // Ignore warning.
                 ...
                 _.startsWith(this.sql, 'ALTER TABLE ')) {
                connection.querySync("CALL SYSPROC.ADMIN_CMD('REORG TABLE " +
                  this.sql.substring(12).split(' ')[0] + "')");
                err = connection.querySync(this.sql);
