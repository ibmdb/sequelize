      ...
      if (value instanceof Utils.SequelizeMethod) {
        ...
        if (field && field.type) {
          ...
          if (field.type.bindParam) {
            return field.type.bindParam(value, { escape: _.identity, field, timezone: this.options.timezone, datewithtz: options.datewithtz, operation: options.operation, bindParam });
          }
        }
      }
    }
