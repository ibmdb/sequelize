...
Sequelize is a promise-based Node.js ORM for Postgres, MySQL, Db2, SQLite and Microsoft SQL Server. It features solid transaction support, relations, read replication and more.
