...
Sequelize is a promise-based Node.js ORM for Postgres, MySQL, Db2, MariaDB, SQLite and Microsoft SQL Server. It features solid transaction support, relations, eager and lazy loading, read replication and more.
